...
public class RoleController {
  ...
  public void addRole(
      @Parameter(description = "String representation of the Firebase User ID", example = "ndj2KkbGwIUbfIUH2BT6700AQ832") @RequestParam @NotBlank String uid,
  ...
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = RoleServiceImpl.UserWithRoles.class)))),
      @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content),
      @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
      @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content)
  })
  ...
  @GetMapping("/me")
  @Operation(summary = "Returns the authenticated user's roles", security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Successful operation", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RoleServiceImpl.UserWithRoles.class))),
      @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content)
  })
  ...
  public List<RoleServiceImpl.UserWithRoles> getUsersByRole(
      @Parameter(description = "User role to filter by", example = "ROLE_MODERATOR") @PathVariable Role role)
