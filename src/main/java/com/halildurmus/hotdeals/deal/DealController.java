...
public class DealController {
  ...
  public int getCountDealsByPostedBy(
      @Parameter(description = "String representation of the User ID", example = "5fbe790ec6f0b32014074bb1") @IsObjectId @RequestParam String postedBy) {
    return service.countDealsByPostedBy(new ObjectId(postedBy));
  }

  @GetMapping("/pending")
  @IsSuper
  @Operation(summary = "Returns all pending deals", security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses({
  ...
  public int getCountDealsByStoreId(
      @Parameter(description = "String representation of the Store ID", example = "5fbe790ec6f0b32014074bb1") @IsObjectId @RequestParam String storeId) {
  ...
  public List<DealGetDTO> getDealsByCategory(
      @Parameter(description = "The category path", example = "/computers") @RequestParam String category,
  ...
  public JsonNode searchDeals(
      ...
      @Parameter(description = "Store IDs", example = "5fbe790ec6f0b32014074bb2, 5fbe790ec6f0b32014074bb3") @RequestParam(value = "stores", required = false) List<String> stores,
      @Parameter(description = "Whether to hide expired deals") @RequestParam(value = "hideExpired", required = false, defaultValue = "false") Boolean hideExpired,
      ...
      @Parameter(description = "Order results by") @RequestParam(value = "order", required = false, defaultValue = "asc") String order,
      @ParameterObject Pageable pageable) {
  ...
  public List<SearchSuggestion> getSuggestions(
      @Parameter(description = "Search query", example = "iph") @NotBlank @Size(min = 3, max = 100) @RequestParam String query) {
  ...
  public DealGetDTO getDeal(
      @Parameter(description = "String representation of the Deal ID", example = "5fbe790ec6f0b32014074bb1") @IsObjectId @PathVariable String id) {
  ...
  public CommentsDTO getComments(
    ...
    List<CommentGetDTO> commentGetDTOs = comments.getContent().stream()
  ...
  public void createCommentReport(
      @Parameter(description = "String representation of the Deal ID", example = "5fbe790ec6f0b32014074bb1") @IsObjectId @PathVariable String id,
      @Parameter(description = "String representation of the Comment ID", example = "5fbe790ec6f0b32014074bb2") @IsObjectId @PathVariable String commentId,
  ...
  public List<DealGetDTO> getDealsByStatus(
      @Parameter(description = "Deal status", example = "PENDING") @PathVariable DealStatus status,
      @ParameterObject Pageable pageable) {
  ...
  @IsSuper
  @Operation(summary = "Syncs Elasticsearch with MongoDB", security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Successfully synced", content = @Content),
      @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
      @ApiResponse(responseCode = "403", description = "Forbidden", content = @Content)
  })
  public ResponseEntity<Void> syncElasticsearch() {
